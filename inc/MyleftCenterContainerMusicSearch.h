...
#ifndef MYLEFT_CONTAINER_MUSIC_SEARCH_H
#define MYLEFT_CONTAINER_MUSIC_SEARCH_H
...
*  
*/
class CMyleftCenterContainerMusicSearch : public CCoeControl, MCoeControlObserver
	...
	typedef enum TReadSearchFormID
	{
        ...
        */
        void ConstructL(CMyleftCenterViewMusicSearch *parent,const TRect& aRect);

        /**
        * Destructor.
        */
        ~CMyleftCenterContainerMusicSearch();
...
//	void MlloLinkClicked(CFunLinkLabel* aLinkLabel, TInt aLinkId);
    ...
    private: //data
        CMyleftCenterViewMusicSearch  *iparent;
